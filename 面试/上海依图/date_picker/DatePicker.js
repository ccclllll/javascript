...
function datePicker(options) {
  ...
  Calendar.prototype._bindEvent = function () {
    this.calendarContainer.addEventListener('click', (e) => {
      ...
      // 生成上一个月的日历
      if (target.classList.contains('previous-month') || (target.classList.contains('operate') && target.classList.contains('previous'))) {
      ...
      // 生成下一个月的日历
      if (target.classList.contains('next-month') || (target.classList.contains('operate') && target.classList.contains('next'))) {
